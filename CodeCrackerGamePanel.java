...
public class CodeCrackerGamePanel extends JPanel {
  ...
  public CodeCrackerGamePanel () { //(CodeCracker c) {
    ...
    BufferedImage womanPic = null;
    try {
      womanPic = ImageIO.read(new File("woman-final.gif"));
      JLabel womanPicLabel = new JLabel(new ImageIcon(womanPic));
      rightPanel.add(womanPicLabel);
    } catch(IOException e) {
      e.printStackTrace();
    }
    ...
    leftPanel.add(level1, BorderLayout.LINE_START);
